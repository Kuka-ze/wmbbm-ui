  ...
  return (
    <Card>
      <Form>
        <Row>
          <Col span={6}>
            <FormItem label="问题状态" {...formItemLayout}>
              {getFieldDecorator('state')(
                <Select placeholder="请选择问题状态"
                >
          ...
          <Col span={6}>
            <FormItem label="请输入" {...formItemLayout}>
              {getFieldDecorator('name')(
                <Input placeholder="问题人、联系人、联系电话" />
              )}
            </FormItem>
          </Col>
          <Col span={5} offset={1}>
