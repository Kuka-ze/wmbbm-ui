  ...
  return (
    <div>
      {authority('list') ? <div>
        ...
        <Card className="mt1">
          {authority('add') ?
            <Link to="/managedAdd"><Button type="primary" className="mb1"><Icon type="plus" />新增所</Button></Link>
            : null
          }
...
function mapStateToProps(state) {
  return {
    ...state.ManagedModel,
    loading: state.loading.models.ManagedModel
  };
}
