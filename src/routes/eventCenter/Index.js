...
function Index(props) {
  ...
  let formListProps = {
    ...
    onChangePage(pageNum) {
      dispatch({
        type: 'EventCenterModel/ajaxList',
        payload: { ...props.params, pageNum }
      })
    },
    onUpdate(record) {
      dispatch({
        type: 'EventCenterModel/ajaxDelete',
...
function mapStateToProps(state) {
  return {
    ...state.EventCenterModel,
    loading: state.loading.models.EventCenterModel
  };
}
