...
class Menus extends React.Component {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    if((this.props.allMenus != nextProps.allMenus) || (this.props.infoMenu != nextProps.infoMenu)) {
      //console.log(nextProps.infoMenu)
  ...
  render() {
    ...
    //console.log(this.state.levelClick2)
    ...
    return (
      <div>
        ...
        <Checkbox
          ...
          indeterminate={this.state.indeterminate} checked={this.state.checkedAll} onChange={this.all.bind(this)}>全选</Checkbox>
          ...
          return (
            <div key={index}>
              <Row className="mt1 sanjiao_zhu" key={`row-${item.id}`}>
                ...
                {/* <div className="sanjiao_shu" onClick={this.retract.bind(this,item.id,"1级")}></div> */}
                  ...
                  return (
                    <div key={`row-${item.id}-${indexs}`} style={(this.lookup(item.id,"1级"))}>
                      <Row style={{marginLeft:30}} className="mt1 sanjiao_zhu" key={`rows-${index}`}>
                        {/* {} */}
                        {/* <div className="sanjiao_shu" onClick={this.retract.bind(this,items.id,"2级")}></div> */}
                        {
