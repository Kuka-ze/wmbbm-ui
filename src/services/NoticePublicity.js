...
const NoticePublicity = {
  ...
  // 列表
  ajaxList: (parameter) => {
    return request('/notice/notice/notice-list', parameter);
  },
  // 删除
  ajaxDelete: (parameter) => {
    return request('/notice/notice/notice-delete', parameter);
  },
  // 新增
  ajaxAdd: (parameter) => {
  ...
  // 置顶
  noticeTop: (parameter) => {
    return request('/notice/notice/notice-top', parameter);
  },
